    ...
    if (isLoading) {
        return (
            <div className="min-h-screen bg-background flex flex-col items-center justify-center">
                ...
                <p className="text-[10px] font-black uppercase tracking-[0.4em] opacity-40">Synchronizing Hub...</p>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-background p-6 md:p-12 max-w-[1800px] mx-auto space-y-12">
            ...
            <header className="flex items-center justify-between">
                <div className="flex items-center gap-6">
                    ...
                    <h1 className="text-4xl font-black italic tracking-tighter uppercase">Focus Hub</h1>
                </div>
                <div className="flex gap-4">
                    <Button variant="outline" onClick={() => navigate("/explore")} className="rounded-full border-white/10 font-bold px-8 h-12 hover:bg-white/5">
            ...
            <Tabs defaultValue={defaultTab} className="space-y-12">
                <div className="flex overflow-x-auto pb-4 -mx-4 px-4 scrollbar-hide">
                    <TabsList className="bg-white/5 p-1 rounded-full border border-white/5">
                        {[
                            { id: 'feed', label: 'Focus Feed' },
                            { id: 'planets', label: 'My Planet' },
